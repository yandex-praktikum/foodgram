# Generated by Django 3.2.3 on 2024-09-25 17:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Имя пользователя уже используется!'}, help_text=('Имя пользователя, не более 150 символов.', 'Допустимые символы: буквы, цифры и @/./+/-/_'), max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(message='Имя пользователя содержит недопустимые символы. В имени пользователя допускается использовать буквы, цифры и символы _.@+-'), recipes.validators.username_validator], verbose_name='Имя пользователя')),
                ('email', models.EmailField(error_messages={'unique': 'Адрес электронной почты уже используется!'}, help_text='Адрес электронной почты, не более 254 символов', max_length=254, unique=True, verbose_name='Адрес электронной почты')),
